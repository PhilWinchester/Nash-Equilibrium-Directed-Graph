...
To install networkx you need to navigate to the networkx folder in Terminal. Once in the networkx-master folder type 'python setup.py install' and this will run the install script created by the creators of the networkx library. Now you can use networkx for all your networking needs.
